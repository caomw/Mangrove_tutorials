...
int main(void)
{
	...
	/* This is the 'Mangrove_tutorial019' tutorial, where the nested arrays of several 'integer (int)' C++ built-in values are validated. */
	...
	/* TASK #1 - creating a new nested array, containing several arrays of 'integer (int)' C++ built-in values. */
	cout<<"\tCreating the nested array 'a', containing several arrays of 'integer (int)' C++ built-in values, ... ";
	a.push_back( vector<int>() );
	a.back()={-20,-3,5,10,20,30,40};
	cout<<"ok"<<endl;
	Mangrove_debug(a);
	cout<<"\tThe total number of the 'integer (int)' C++ built-in values in the nested array 'a' is "<<Mangrove_valuesNumber(a)<<"."<<endl;
	...
	cout<<"ok"<<endl;
	Mangrove_debug(a1);
	cout<<"\tThe total number of the 'integer (int)' C++ built-in values in the reconstructed nested array 'a' is "<<Mangrove_valuesNumber(a1)<<"."<<endl;
