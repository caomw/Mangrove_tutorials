...
int main(void)
{
	...
	str.clear();
	float f=-1936.27;
	cout<<"\tConverting the 'single floating-point (float)' C++ built-in value "<<f<<" as the corresponding string (satisfying the ASCII encoding) ... ";
	str=Mangrove_float2string(f,false);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'single floating-point (float)' C++ built-in value (satisfying the ASCII encoding) ... ";
	cout.flush();
	...
	str.clear();
	double d=-1e+32;
	cout<<"\tConverting the 'double floating-point (double)' C++ built-in value "<<d<<" as the corresponding string (satisfying the ASCII encoding) ... ";
	str=Mangrove_double2string(d,false);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'double floating-point (double)' C++ built-in value (satisfying the ASCII encoding) ... ";
	cout.flush();
