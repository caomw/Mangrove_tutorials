/*************************************************************************************************************************************************************************
 * This source code provides the 'Tutorial Example-008' for the Mangrove Topological Data Structure Library (Mangrove TDS Library 3.0)
 *                                                                           				    
 ...
 * more details.
 *
 * Mangrove_tutorial008.cpp - the 'Tutorial Example-008' for the 'Mangrove TDS Library 3.0'.
 *************************************************************************************************************************************************************************/
...
/// The <i>main function</i> for the <i>'Mangrove_tutorial008'</i> program.
/**
 * \file Mangrove_tutorial008.cpp
...
int main(void)
{
	...
	/* This is the 'Mangrove_tutorial008' tutorial, where the serialization operations, involving several values, that are described by the C++ built-in types (satisfying the big-endian binary encoding), are validated. */
	Mangrove_exportCopyrightDisclaimer ("The 'Mangrove_tutorial008' Tutorial");
	cout.flush();
	
	/* TASK #1 - exporting several values, described by the C++ built-in types, on a specific binary file  (satisfying the big-endian binary encoding). */
	cout<<"\tExporting several values, described the C++ built-in types, on the 'big_endian_values.bin' binary file (satisfying the big-endian binary encoding):"<<endl<<endl;
	cout.flush();
	out.open("big_endian_values.bin",ios::binary);
	...
	Mangrove_exportChar(c,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportUchar(uc,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportShort(s,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportUshort(us,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportInt(i,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportUint(ui,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportLong(l,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportUlong(ul,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportFloat(f,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl;
	cout.flush();
	...
	Mangrove_exportDouble(d,MANGROVE_FORMAT_BIG_ENDIAN,out);
	cout<<"ok"<<endl<<endl;
	cout.flush();
	out.close();
	
	/* TASK #2 - reading and parsing several values, described by the C++ built-in types, from a specific binary file  (satisfying the big-endian binary encoding). */
	cout<<"\tReading and parsing several values, described the C++ built-in types, from the 'big_endian_values.bin' binary file (satisfying the big-endian binary encoding):"<<endl<<endl;
	cout.flush();
	in.open("big_endian_values.bin",ios::binary);
	...
	char c1=Mangrove_readChar(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	uchar uc1=Mangrove_readUchar(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	short s1=Mangrove_readShort(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	ushort us1=Mangrove_readUshort(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	int i1=Mangrove_readInt(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	uint ui1=Mangrove_readUint(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	long l1=Mangrove_readLong(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	ulong ul1=Mangrove_readUlong(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	float f1=Mangrove_readFloat(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	double d1=Mangrove_readDouble(MANGROVE_FORMAT_BIG_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	cout.flush();
	in.close();
	cout<<"\tRemoving the 'big_endian_values.bin' binary file ... ";
	Mangrove_removeFile(string("big_endian_values.bin"));
	cout<<"ok"<<endl<<endl;
	cout.flush();
	return EXIT_SUCCESS;
}
