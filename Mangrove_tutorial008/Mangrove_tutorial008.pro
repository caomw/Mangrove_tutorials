...
#
# This QT project file generates the Makefiles for compiling the 'Mangrove_tutorial008' program. This latter is one of the custom 'Tutorial Examples' for the 
...
#
# Mangrove_tutorial008.pro
#####################################################################################################################################################################

# Basic options, directories, headers and sources for the 'Mangrove_tutorial008' program.
TEMPLATE = app
LANGUAGE = C++
CONFIG += console c++11 debug_and_release
CONFIG -= app_bundle
TARGET = Mangrove_tutorial008
QT += core
QT -= gui
include(../common_defs)
DESTDIR = ../bin/
...
SOURCES += Mangrove_tutorial008.cpp
