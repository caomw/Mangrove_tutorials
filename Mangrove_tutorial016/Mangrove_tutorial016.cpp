...
int main(void)
{
	 ...
	 * Here, the hashing value of a given 'uint' value 'x' corresponds with 'x' itself. The actual comparison are performed by the 'Mangrove_DataComparatorWithHashing' template class. */
	Mangrove_exportCopyrightDisclaimer("Mangrove_tutorial016");
