...
int main(void)
{
	...
	/* This is the 'Mangrove_tutorial018' tutorial, where the nested lists of several 'integer (int)' C++ built-in values are validated. */
	...
	/* TASK #1 - creating a new nested list, containing several lists of 'integer (int)' C++ built-in values. */
	...
	cout<<"ok"<<endl;
	Mangrove_debug(l);
	cout<<"\tThe total number of the 'integer (int)' C++ built-in values in the nested list 'l' is "<<Mangrove_valuesNumber(l)<<"."<<endl;
	...
	cout<<"ok"<<endl;
	Mangrove_debug(l1);
	cout<<"\tThe total number of the 'integer (int)' C++ built-in values in the reconstructed nested list 'l' is "<<Mangrove_valuesNumber(l1)<<"."<<endl;
