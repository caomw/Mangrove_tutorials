...
int main(void)
{
	...
	/* First, we export the copyright disclaimer. Then, we validate the serialization operations, involving the C++ built-in types (satisfying the binary little-endian encoding). */
	Mangrove_exportCopyrightDisclaimer ("Mangrove_tutorial009");
	cout<<"\tExporting several values of the C++ built-in types on the 'little_endian_values.bin' file (satisfying the binary little-endian encoding)"<<endl<<endl;
	cout.flush();
	...
	/* Reading and parsing the values of the C++ built-in types (just exported) from the 'little_endian_values.txt' file (satisfying the binary little-endian encoding). */
	cout<<"\tReading and parsing the values of the C++ built-in types (just exported) from the 'little_endian_values.txt' file (satisfying the binary little-endian encoding)"<<endl<<endl;
	cout.flush();
	...
	c1=Mangrove_readChar(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	uc1=Mangrove_readUchar(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	s1=Mangrove_readShort(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	us1=Mangrove_readUshort(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	i1=Mangrove_readInt(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	ui1=Mangrove_readUint(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	l1=Mangrove_readLong(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	ul1=Mangrove_readUlong(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	f1=Mangrove_readFloat(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	d1=Mangrove_readDouble(MANGROVE_FORMAT_LITTLE_ENDIAN,in);
	cout<<"ok"<<endl;
	...
	cout.flush();
	in.close();
	cout<<"\tRemoving the 'little_endian_values.bin' file ... ";
	Mangrove_removeFile("little_endian_values.bin");
	cout<<"ok"<<endl<<endl;
	cout.flush();
	return EXIT_SUCCESS;
}
