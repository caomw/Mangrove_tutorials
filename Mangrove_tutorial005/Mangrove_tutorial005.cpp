/*************************************************************************************************************************************************************************
 * This source code provides the 'Tutorial Example-005' for the Mangrove Topological Data Structure Library (Mangrove TDS Library 3.0)
 *                                                                           				    
 ...
 * more details.
 *
 * Mangrove_tutorial005.cpp - the 'Tutorial Example-005' for the 'Mangrove TDS Library 3.0'.
 *************************************************************************************************************************************************************************/
...
/// The <i>main function</i> for the <i>Mangrove_tutorial005</i> program.
/**
 * \file Mangrove_tutorial005.cpp
...
int main(void)
{
	...
	Mangrove_exportCopyrightDisclaimer ("Mangrove_tutorial005");
	str.clear();
	c=('a');
	cout<<"\tConverting the 'char' C++ built-in value '"<<(int)c<<"' ("<<c<<") as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_char2string(c,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'char' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	c1=Mangrove_string2char(str,true);
	...
	uc=('#');
	str.clear();
	cout<<"\tConverting the 'unsigned char (uchar)' C++ built-in value '"<<(uint)uc<<"' ("<<uc<<") as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_uchar2string(uc,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned char (uchar)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	uc1=Mangrove_string2uchar(str,true);
	...
	str.clear();
	s=-125;
	cout<<"\tConverting the 'short' C++ built-in value "<<s<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_short2string(s,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'short' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	s1=Mangrove_string2short(str,true);
	...
	str.clear();
	us=1024;
	cout<<"\tConverting the 'unsigned short (ushort)' C++ built-in value "<<us<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_ushort2string(us,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned short (ushort)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	us1=Mangrove_string2ushort(str,true);
	...
	str.clear();
	i=-245;
	cout<<"\tConverting the 'int' C++ built-in value "<<i<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_int2string(i,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'int' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	i1=Mangrove_string2int(str,true);
	...
	str.clear();
	ui=3056;
	cout<<"\tConverting the 'unsigned int (uint)' C++ built-in value "<<ui<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_uint2string(ui,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned int (uint)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	ui1=Mangrove_string2uint(str,true);
	...
	str.clear();
	l=-2455;
	cout<<"\tConverting the 'long' C++ built-in value "<<l<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_long2string(l,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'long' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	l1=Mangrove_string2long(str,true);
	...
	str.clear();
	ul=342345;
	cout<<"\tConverting the 'unsigned long (ulong)' C++ built-in value "<<ul<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_ulong2string(ul,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned long (ulong)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	ul1=Mangrove_string2ulong(str,true);
	...
	str.clear();
	f=-1936.27;
	cout<<"\tConverting the 'float' C++ built-in value "<<f<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_float2string(f,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'float' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	f1=Mangrove_string2float(str,true);
	...
	str.clear();
	d=-1e+32;
	cout<<"\tConverting the 'double' C++ built-in value "<<d<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_double2string(d,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'"<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'double' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	d1=Mangrove_string2double(str,true);
