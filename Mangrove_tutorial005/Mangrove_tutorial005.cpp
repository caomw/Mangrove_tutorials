...
int main(void)
{
	...
	/* This is the 'Mangrove_tutorial005' tutorial, where the mutual conversions between the strings and the values, described by several C++ built-in types, are validated (binary format). */
	Mangrove_exportCopyrightDisclaimer ("The 'Mangrove_tutorial005' Tutorial");
	cout.flush();
	
	/* TASK #1 - validating the mutual conversion between a string and a value, described by the C++ 'character (char)' built-in type. */
	str.clear();
	char c=('a');
	cout<<"\tConverting the 'character (char)' C++ built-in value '"<<(int)c<<"' ("<<c<<") as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_char2string(c,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'character (char)' C++ built-in value (satisfying the binary encoding) ... ";
	char c1=Mangrove_string2char(str,true);
	...
	cout.flush();
	uchar uc1=Mangrove_string2uchar(str,true);
	...
	str.clear();
	short s=-125;
	cout<<"\tConverting the 'short integer (short)' C++ built-in value "<<s<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_short2string(s,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'short integer (short)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	short s1=Mangrove_string2short(str,true);
	...
	str.clear();
	ushort us=1024;
	cout<<"\tConverting the 'unsigned short integer (ushort)' C++ built-in value "<<us<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_ushort2string(us,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned short integer (ushort)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	ushort us1=Mangrove_string2ushort(str,true);
	...
	str.clear();
	int i=-36245;
	cout<<"\tConverting the 'integer (int)' C++ built-in value "<<i<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_int2string(i,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'integer (int)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	int i1=Mangrove_string2int(str,true);
	...
	str.clear();
	uint ui=86245;
	cout<<"\tConverting the 'unsigned integer (uint)' C++ built-in value "<<ui<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_uint2string(ui,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned integer (uint)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	uint ui1=Mangrove_string2uint(str,true);
	...
	str.clear();
	long l=-1234567;
	cout<<"\tConverting the 'long integer (long)' C++ built-in value "<<l<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_long2string(l,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'long integer (long)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	long l1=Mangrove_string2long(str,true);
	...
	str.clear();
	ulong ul=3423453;
	cout<<"\tConverting the 'unsigned long integer (ulong)' C++ built-in value "<<ul<<" as the corresponding string (satisfying the binary encoding) ... ";
	str=Mangrove_ulong2string(ul,true);
	cout<<"ok"<<endl<<"\tThe resulting string of this conversion is '"<<str<<"'."<<endl;
	cout<<"\tRetroprojecting the existing string onto the corresponding 'unsigned long integer (ulong)' C++ built-in value (satisfying the binary encoding) ... ";
	cout.flush();
	ulong ul1=Mangrove_string2ulong(str,true);
